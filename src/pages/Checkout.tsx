...
export default function CheckoutPage() {
  ...
  const validateForm = () => {
    ...
    if (!phoneRegex.test(phone)) {
      setPhoneError(
        'Please enter a valid phone number (e.g., +82-010-1234-5678)'
      );
      isValid = false;
    } else {
      setPhoneError(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Example: Send order to a backend API
      /*
      ...
      */
      ...
      alert(
        `Order placed successfully with ${paymentMethod === 'cash' ? 'cash' : 'card'} payment!`
      );
      router.push('/'); // Redirect to home or product page
    } catch (error) {
  ...
  return (
    <div className="bg-gray-100 font-sans min-h-screen p-6 max-w-6xl mx-auto">
      ...
      <nav className="text-sm text-gray-500 mb-6">
        ...
        <a href="/product/espresso-ice-coffee" className="hover:underline">
          Product
        </a>
        <span className="mx-2">/</span>
        <a href="/product/espresso-ice-coffee" className="hover:underline">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="mb-6">
            ...
            >
              ...
              <option value="card">
                Pay with Card (9900-0000-0000-2023 / 24)
              </option>
            </select>
            {paymentMethod === 'card' && (
              <p className="text-xs text-gray-500 mt-2">
                Note: Card payments require integration with a payment gateway
                like Stripe.
              </p>
            )}
          </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-600">
                      {item.service} | Size: {item.size} | Qty: {item.quantity}
                    </p>
