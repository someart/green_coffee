...
export  function ProductModal({ isOpen, onClose, onSave, editingSlug, formData, setFormData }: ProductModalProps) {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white p-6 rounded-xl shadow max-w-lg w-full">
        <h2 className="text-xl font-semibold mb-4">{editingSlug ? 'Edit Product' : 'Add Product'}</h2>
